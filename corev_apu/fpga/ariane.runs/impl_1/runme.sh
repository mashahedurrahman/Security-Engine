...
HD_PWD='/home/mashahed/projects/cva6/cva6/corev_apu/fpga/ariane.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ariane_xilinx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ariane_xilinx.tcl -notrace
